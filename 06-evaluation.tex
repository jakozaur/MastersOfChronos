...
RSSI is usually used to determink the quality of radio communication.
It may be also utilized to estimate the distance between a sender and a listener.
Though, single meassurment may be misleading, a median from series of transmissions is a good indicator.
...
Even from a signal LQI data point gives a good prediction of packet losts.
